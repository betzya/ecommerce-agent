...
这一版代码合并原第 05 课和第 06 课的能力推进：先用 system prompt 堵住 AI 客服乱承诺，再把电商活动、售后和客服边界文档全量塞进 Prompt，观察长上下文和新旧规则冲突。

它解决本课的两个连续事故：

- AI 客服代表电商乱承诺退款、赔偿、物流和优惠叠加。
...
```bash
cd code/agent-course-versions/lesson-05-prompt-boundary/backend
python main.py
```
