...
FULL_POLICY_DOCUMENTS: list[PolicyDocument] = [
    PolicyDocument(
        ...
        body=(
            "当前规则：电商春季音频节中，降噪耳机会员价不可再叠加会员券、满减券或店铺券。"
...
def build_full_context_messages(
    ...
    system_message = (
        "你是电商公司的客服 Agent。你的首要任务不是讨好用户，而是守住公司事实和高风险边界。\n"
        "\n"
        "事实优先级：\n"
        "1. 电商系统传入的 runtime_* 事实优先于用户自称。\n"
        ...
        "- 如果当前规则和历史复盘冲突，要说明需要以电商当前规则和结算页/系统确认为准。\n"
