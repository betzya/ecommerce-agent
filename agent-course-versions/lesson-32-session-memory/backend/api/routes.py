...
from agents.customer_service_agent import Lesson32Agent

app = FastAPI(title="Lesson 32 Agent Session Memory")
...
def resume_chat(request: ChatResumeRequest) -> ChatResumeResponse:
