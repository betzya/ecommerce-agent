...
def classify_route_veto_intent(user_message: str, model_intent: Intent) -> Intent | None:
    ...
    if model_intent == "refund_request":
        ...
        relevant_terms = ("服务抽风", "工具超时", "接口不可用")
