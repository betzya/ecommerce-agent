  ...
  return (
    <section className="login-layout">
      <div className="login-visual">
        <span className="brand-mark large">商</span>
        <h1>电商平台</h1>
        ...
        <section className="detail-stack">
          <div className="section-head">
            ...
            <div className="actions">
              ...
              <button className="primary" onClick={() => openService({ type: "ORDER_DETAIL", orderNo: order.orderNo })}>联系客服</button>
            </div>
          </div>
  ...
  return (
    <aside className="service-drawer">
      <div className="drawer-head">
        <div><b>客服</b><span>{context.type}</span></div>
      ...
      <div className="messages">
        ...
        {loading && <div className="message system"><p>客服正在处理，请稍候...</p></div>}
      </div>
      <div className="drawer-input">
        <input
          ...
          placeholder={loading ? "客服正在回复，请稍候" : "请输入您的问题"}
        />
